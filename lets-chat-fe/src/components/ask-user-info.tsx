...
export default function AskUserInfo() {
  ...
  const handleUsernameSet = (e: FormEvent) => {
    ...
    localStorage.setItem("username", usernameRef.current.value.trim());
  ...
  return (
    <div className="h-screen flex items-center justify-center">
      ...
      >
        ...
        />
        <button className="border border-black rounded-sm px-4 w-fit">Set</button>
      </form>
    </div>
  );
}
